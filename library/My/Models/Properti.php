...
class Properti extends ModelAbstract {

    private function getParentTable() {
        $dbAdapter = $this->getServiceLocator()->get('Zend\Db\Adapter\Adapter');
        return new \My\Storage\storageProperti($dbAdapter);
    }

    public function __construct() {
        $this->setTmpKeyCache('tmpProperti');
        parent::__construct();
    }
    ...
    public function getListLimit($arrCondition = array(), $intPage = 1, $intLimit = 15, $strOrder = 'prop_id DESC') {
        $keyCaching = 'getListLimitProperti:';
