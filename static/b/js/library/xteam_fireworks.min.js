...
Xteam.fireworkShow = function (a, c) {
    function e() {
        ...
        if (!h[0].getContext)
            return false;
        h.attr({height: a.height(), width: a.width()}).css({position: "absolute", display: "block", top: 0, left: 0, zIndex: 99999}).appendTo(a);
...
Xteam.firework = function (a) {
    ...
    var j = {draw: e}, l = a.getContext(), n = Xteam.FireworkParticle, h = 70, k, i, m, o, f;
    c();
    return j
};
...
Xteam.FireworkParticle.prototype = {getStyle: function () {
        ...
        if (this.f < this.max) {
            ...
            c.beginPath();
            c.moveTo(Math.round(2 * this.size), 0);
...
Xteam.Canvas.scene = function (a) {
    ...
    var h = {register: c, remove: d, getContext: l, getCanvas: n, destroy: j}, k = a.getContext("2d"), i = [], m = [], o = setInterval(function () {
