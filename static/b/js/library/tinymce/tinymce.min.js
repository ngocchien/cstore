...
$(document).ready(function () {
    tinymce.PluginManager.add('customColor', function (editor, url) {
        editor.addButton('customColor', {
            title: 'Color',
            type: 'menubutton',
            icon: 'mce-ico mce-i-forecolor',
            menu: [               
{  text: 'your text',value: 'tc1', classes: ' tc1', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc2', classes: ' tc2', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc3', classes: ' tc3', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc4', classes: ' tc4', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc5', classes: ' tc5', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc6', classes: ' tc6', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc7', classes: ' tc7', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc8', classes: ' tc8', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc9', classes: ' tc9', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
{  text: 'your text',value: 'tc10', classes: ' tc10', icon: false, onclick: function () {  editor.focus();  editor.selection.setContent("<span class=\"" + this.value() + "\">" + editor.selection.getContent() + '</span>');}   },
        ]
        });
    });
});