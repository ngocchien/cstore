            ...
            function i(l) {
                ...
                if (m) {
                    a.each(m, function (v, u) {
                        ...
                        n.type = "hidden";
                        n.value = fileData;
                        var o = '<li class="newImage" style="background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #DDDDDD;border-radius: 2px 2px 2px 2px;box-shadow: 1px 1px 2px #EEEEEE;float: left;margin: 0 5px 5px 0;padding: 5px;list-style:none outside none;margin-bottom:10px;display:inline;"><img class="image" src="' + u[q][r] + '" alt="" style="display: block;margin-bottom: 10px;" /><span style="display: block;text-align: right;"><a title="Xem" class="view" href="' + u[t] + '" target="_blank" style="vertical-align: middle;cursor: pointer;display: inline-block;height: 16px;margin-left: 5px;opacity: 0.5;vertical-align: middle;width: 16px;background-image: url(data:image/png;base64,);"></a><a title="Xóa" class="delete" style="vertical-align: middle;cursor: pointer;display: inline-block;height: 16px;margin-left: 5px;opacity: 0.5;vertical-align: middle;width: 16px;background-image: url(data:image/png;base64,);"></a><div id="jsonData"></div></span></li>';
                        g.preview.prepend(o);
                        g.preview.show();
                        a("#jsonData").append(n);
                        var s = a.Callbacks();
